...
<article class="py-5  text-center">
  <div>
    <h3 class="display-5 text-white text-capitalize"> Authentication page</h3>
  </div>
</article>
</section>
<section class="pt-4">
 ...
 <div class="w-50 mx-auto">
  <form>
    ...
    <div class="form-group">
      <label for="pwd">Enter New Pin:</label>
      <input type="password" name="en" class="form-control" id="pwd">
    </div>
...
if(isset($_REQUEST['submit']))
{
    ...
    $q="Select * from account where acno='$a' and Pin='$pin'";
    ...
    if($x>0)
    {
        ...
        $pin=$r[1];
            $p="update account set Pin='$en' where acno='$a'";
            $s=mysqli_query($con,$p) or die("Can't Update Password".mysqli_error($con));
           echo"<h3> pin updated sucessfully</h3>";
