...
<article class="py-5  text-center">
  <div>
    <h3 class="display-5 text-white text-capitalize">Deposit Amount Form</h3>
  </div>
</article>
</section>
</br></br>
<section class="pt-4">
 ...
 <div class="w-50 mx-auto">
  <form>
    ...
    <div class="form-group">
      <label for="pwd">Enter Amount to deposit:</label>
      <input type="password" name="am"class="form-control" id="pwd">
    </div>
    
    <button type="submit" name="submit" class="btn btn-danger">Deposit</button>
  </form>
</div> 
  </div>
</section>
    ...
    if($x>0)
    {
       ...
       $camt=$r[10];
        { 
            ...
            $t=date('h:i:s');
            $dt=$d." ".$t;
            $q="insert into mytrans(acno,amount,dt,ds)values('$ac','$a','$dt','deposit')";
            mysqli_query($con,$q);

            echo "<h3>After deposit $a your Current Balance is = $camt</h3>";
        }
