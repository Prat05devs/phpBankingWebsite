...
body {
    ...
    text-align: var(--bs-body-text-align);--$_POST
...
<article class="py-5  text-center">
  <div>
    <h3 class="display-5 text-white text-capitalize"> Show Account Summary</h3>
  </div>
</article>
</section>
</br></br>
 ...
 <div class="w-50 mx-auto">
  <form method="post">
    <div class="form-group">
      ...
      <input type="text"  name="acno" class="form-control" id="text" autocomplete="off">
    </div>
    <div class="form-group">
 ...
 if(isset($_REQUEST['submit']))
{
    ...
    if($x>0)
    {
        ...
        if($camt>=$ac)
        {
          ...
          $t=date('h:i:s');
          $dt=$d." ".$t;
          $q="insert into mytrans(acno,amount,dt,ds)values('$ac','$a','$dt','Withdraw')";
          mysqli_query($con,$q);
          echo "<h3>After withdrawl $a your Current Balance is = $camt</h3>";
      }
      $q="select * from mytrans";
      $rs=mysqli_query($con,$q);
      echo "<br><table class='table table-bordered table-striped table-hover table-dark'>";
      echo "<tr><td>ID</td><td>Acno</td><td>Amount</td><td>Dt</td><td>ds</td></tr>";
      while($r=mysqli_fetch_array($rs))
      {
          echo "<tr><td>$r[0]</td><td> $r[1]</td><td>  $r[2]</td><td>  $r[3]</td><td>  $r[4]</td><td></td></tr>";
      }
