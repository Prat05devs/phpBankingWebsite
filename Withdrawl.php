...
<article class="py-5  text-center">
  <div>
    <h3 class="display-5 text-white text-capitalize">withdrawl Form</h3>
  </div>
</article>
</section>
<section class="pt-4">
 ...
 <div class="w-50 mx-auto">
  <form>
    <div class="form-group">
      Enter Account No
      <input type="text" class="form-control" name="acno" id="email" autocomplete="off">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label for="pwd">Enter Withdrawl Amount:</label>
      <input type="password" name="am" class="form-control" id="pwd">
    </div>
    
    <button type="submit"  name="submit" class="btn btn-danger">Withdrawl</button>
  </form>
</div> 
  </div>
</section>
